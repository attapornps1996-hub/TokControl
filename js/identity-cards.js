...
(function (global) {
    ...
    function buildTikTokCardHtml(layout, settings, live, colors) {
        ...
        const avatar = s.avatarUrl || avatarFallback(user, '00f2ea');
        ...
        if (layout === 'livestrip') {
            return `<div class="id-card id-tt id-tt-livestrip" style="${style}">
                <div class="id-tt-strip">${liveBadge}<img class="id-tt-strip-av" src="${esc(avatar)}" alt=""><div class="id-tt-strip-meta"><b>${esc(name)}</b><span>@${esc(user)}</span></div></div>
        ...
        if (layout === 'compact') {
            return `<div class="id-card id-tt id-tt-compact" style="${style}">
                <img class="id-tt-compact-av" src="${esc(avatar)}" alt="">
        ...
        if (layout === 'glass') {
            return `<div class="id-card id-tt id-tt-glass" style="${style}">
                ${liveBadge}<img class="id-tt-glass-av" src="${esc(avatar)}" alt="">
        ...
        if (layout === 'neon') {
            return `<div class="id-card id-tt id-tt-neon" style="${style}">
                ...
                <img class="id-tt-neon-av" src="${esc(avatar)}" alt="">
        ...
        if (layout === 'banner') {
            return `<div class="id-card id-tt id-tt-banner" style="${style}">
                <div class="id-tt-banner-head">${liveBadge}<img src="${esc(avatar)}" alt=""><div><b>${esc(name)}</b><span>@${esc(user)}</span></div><div class="id-tt-banner-follow"><small>FOLLOWERS</small><strong>${esc(fmtNum(followers))}</strong></div></div>
        ...
        if (layout === 'split') {
            return `<div class="id-card id-tt id-tt-split" style="${style}">
                <div class="id-tt-split-left">${liveBadge}<img src="${esc(avatar)}" alt=""><div class="id-tt-split-name">${esc(name)}</div><div class="id-tt-split-user">@${esc(user)}</div></div>
        ...
        if (layout === 'pill') {
            return `<div class="id-card id-tt id-tt-pill" style="${style}">
                <img src="${esc(avatar)}" alt=""><div class="id-tt-pill-mid"><b>${esc(name)}</b><span>@${esc(user)} · ${esc(fmtNum(followers))} followers</span></div>${liveBadge}
            </div>`;
        }
        ...
        return `<div class="id-card id-tt id-tt-classic" style="${style}">
            ...
            <img class="id-tt-classic-av" src="${esc(avatar)}" alt="">
    ...
    function buildRobloxCardHtml(layout, settings, profile, colors) {
        ...
        if (layout === 'neon') {
            return `<div class="id-card id-rbx id-rbx-neon" style="${style}">${rbxLogo}${status}
                <img class="id-rbx-neon-av" src="${esc(avatar)}" alt="">
        ...
        if (layout === 'minimal') {
            return `<div class="id-card id-rbx id-rbx-minimal" style="${style}">${rbxLogo}${status}
                <img class="id-rbx-min-av" src="${esc(avatar)}" alt="">
        ...
        if (layout === 'badge') {
            return `<div class="id-card id-rbx id-rbx-badge" style="${style}">${rbxLogo}${status}
                <div class="id-rbx-badge-wrap"><img src="${esc(avatar)}" alt=""></div>
        ...
        if (layout === 'statsbar') {
            return `<div class="id-card id-rbx id-rbx-statsbar" style="${style}">${rbxLogo}${status}
                <div class="id-rbx-statsbar-top"><img src="${esc(avatar)}" alt=""><div><b>${esc(name)}</b><span>@${esc(user)}</span></div></div>
        ...
        if (layout === 'blocky') {
            return `<div class="id-card id-rbx id-rbx-blocky" style="${style}">${rbxLogo}${status}
                <img class="id-rbx-blocky-av" src="${esc(avatar)}" alt="">
        ...
        if (layout === 'gradient') {
            return `<div class="id-card id-rbx id-rbx-gradient" style="${style}">${rbxLogo}${status}
                <img class="id-rbx-grad-av" src="${esc(avatar)}" alt="">
        ...
        if (layout === 'hud') {
            return `<div class="id-card id-rbx id-rbx-hud" style="${style}"><div class="id-rbx-hud-scan"></div>${rbxLogo}${status}
                ...
                <img class="id-rbx-hud-av" src="${esc(avatar)}" alt="">
        ...
        return `<div class="id-card id-rbx id-rbx-classic" style="${style}">${rbxLogo}${status}
            <img class="id-rbx-classic-av" src="${esc(avatar)}" alt="">
    ...
    async function fetchTikTokProfile(username) {
        const u = String(username || '').trim().replace(/^@+/, '');
        if (!u) return { error: 'กรุณาระบุ TikTok username' };
        try {
